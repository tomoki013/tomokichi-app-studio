...
const newsPostsJa: NewsPost[] = [
  {
    ...
    summary:
      "訪れた国や地域を地図の色として残すColorviaが、本日よりApp Storeでダウンロードいただけます。",
    body: [
      "Colorviaを本日App Storeでリリースしました。訪れた国を選ぶだけで世界地図が色づき、対応11か国では都道府県や州など国の内側まで記録できます。",
      "基本機能はすべて無料です。一部端末ではホーム下部にバナー広告が表示される場合があります。買い切りの「広告を削除」で非表示にできます。",
  ...
  },
  {
    ...
    summary:
      "機能、地域マップ、使い方、FAQ、プライバシーポリシー、利用規約をまとめて掲載しています。",
    body: [
...
const newsPostsEn: NewsPost[] = [
  {
    ...
    summary:
      "Colorvia, for colouring the countries and regions you've visited, is available to download starting today.",
    body: [
      ...
      "Every core feature is free. A banner ad may appear at the bottom of Home on some devices. A one-time Remove Ads purchase hides it.",
