...
export const supportCopy = {
  ja: {
    ...
    optional: "任意",
    email: "返信先メールアドレス",
    replyRequested: "この件について返信を希望する",
    replyRequestedQuestion: "この質問への返信を希望する",
    message: "お問い合わせ内容",
    submit: "送信する",
    submitting: "送信しています…",
    privacyPrefix: "送信前に",
  ...
  en: {
    ...
    replyRequested: "I’d like a reply about this",
    replyRequestedQuestion: "I’d like a reply to this question",
    message: "Message",
    submit: "Send",
    submitting: "Sending…",
